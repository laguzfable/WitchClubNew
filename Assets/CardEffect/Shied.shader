...
_GhostFX_ClipUp_1("_GhostFX_ClipUp_1", Range(0, 1)) = 0.7
_GhostFX_ClipDown_1("_GhostFX_ClipDown_1", Range(0, 1)) = 0.7
_GhostFX_ClipLeft_1("_GhostFX_ClipLeft_1", Range(0, 1)) = 0.7
_GhostFX_ClipRight_1("_GhostFX_ClipRight_1", Range(0, 1)) = 0.7
...
float4 _GhostFX_1 = GhostFX(_MainTex_1,DistortionUV_1,_GhostFX_Smooth_1,_GhostFX_ClipUp_1,_GhostFX_ClipDown_1,_GhostFX_ClipLeft_1,_GhostFX_ClipRight_1);
float4 _CircleFade_1 = Circle_Fade(_GhostFX_1,i.texcoord,_CircleFade_PosX_1,_CircleFade_PosY_1,_CircleFade_Size_1,_CircleFade_Dist_1);
float4 _ShinyFX_1 = ShinyFX(_CircleFade_1,i.texcoord,_ShinyFX_Pos_1,_ShinyFX_Size_1,_ShinyFX_Smooth_1,_ShinyFX_Intensity_1,_ShinyFX_Speed_1);
