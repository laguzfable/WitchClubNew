...
Shader "Shadero Customs/SelectFrameEffect01"
{
Properties
{
...
_Generate_Xray_PosX_1("_Generate_Xray_PosX_1", Range(0, 1)) = 0.5
_Generate_Xray_PosY_1("_Generate_Xray_PosY_1", Range(0, 1)) = 0.5
_Generate_Xray_Number_1("_Generate_Xray_Number_1", Range(1, 128)) = 16
_Generate_Xray_Speed_1("_Generate_Xray_Speed_1", Range(-8, 8)) = 0
...
float _Generate_Xray_PosX_1;
float _Generate_Xray_PosY_1;
float _Generate_Xray_Number_1;
float _Generate_Xray_Speed_1;
...
float4 _Generate_Xray_1 = Generate_Xray(KaleidoscopeUV_1,_Generate_Xray_PosX_1,_Generate_Xray_PosY_1,_Generate_Xray_Number_1,_Generate_Xray_Speed_1,0);
float4 _PlasmaLightFX_1 = PlasmaLight(_Generate_Xray_1,i.uv_MainTex,_PlasmaLightFX_Fade_1,_PlasmaLightFX_Speed_1,_PlasmaLightFX_BW_1);
