...
Shader "Shadero Customs/WarFogEffect"
{
Properties
{
[PerRendererData] _MainTex("Sprite Texture", 2D) = "white" {}
_Generate_Fire_PosX_1("_Generate_Fire_PosX_1", Range(-1, 2)) = 0.034
_Generate_Fire_PosY_1("_Generate_Fire_PosY_1", Range(-1, 2)) = -0.376
_Generate_Fire_Precision_1("_Generate_Fire_Precision_1", Range(0, 1)) = 0.085
