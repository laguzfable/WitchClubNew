...
Shader "Shadero Customs/CardEffect_Green"
{
Properties
{
[PerRendererData] _MainTex("Sprite Texture", 2D) = "white" {}
_Burn_Value_1("_Burn_Value_1", Range(0, 1)) = 0.048
_Burn_Speed_1("_Burn_Speed_1", Range(-8, 8)) = -6.2
...
float4 _Burn_1 = BurnFX(_MainTex_1,i.texcoord,_Burn_Value_1,_Burn_Speed_1,1);
