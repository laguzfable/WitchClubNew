    ...
    */
    ...
    public void PlayAction()
    {
        if(result != null)
        {
            ...
            {
                combatSystem.combatTxtPanel.DisplaySystemText("無法出超過2張卡片");
                return;
            }
