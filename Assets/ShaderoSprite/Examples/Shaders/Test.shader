...
/// Shader generate with Shadero 1.7.0                      //
...
_FourGradients_Color1_1("_FourGradients_Color1_1", COLOR) = (1,0,0,1)
...
_FourGradients_Color4_1("_FourGradients_Color4_1", COLOR) = (1,1,0,1)
...
float2 RotationUV_1 = RotationUV(KaleidoscopeUV_1,RotationUV_Rotation_1,RotationUV_Rotation_PosX_1,RotationUV_Rotation_PosY_1,RotationUV_Rotation_Speed_1);
float4 NewTex_1 = tex2D(_NewTex_1,RotationUV_1);
float4 _FourGradients_1 = Four_Gradients(NewTex_1,i.texcoord,_FourGradients_Color1_1,_FourGradients_Color2_1,_FourGradients_Color3_1,_FourGradients_Color4_1);
